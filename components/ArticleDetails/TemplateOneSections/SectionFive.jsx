        ...
        <Slider
          slides={data.map((item, index) => (
            <div key={index}>
              ...
              />
              <span className="text-[12px] xl:text-[0.729vw] text-mainBlack opacity-50">
                {item?.text}
              </span>
            </div>
          ))}
...
const writeUp = {
  image: "/images/article/business/Q Jatin Khanna, CEO, Sarovar Hotels.jpg",
  name: "Vijay Thacker",
...
const data = [
  {
    image: "/images/article/business/03.jpg",
    text: "He wears a sweater by MARTINE ROSE. | Image credit XYZ",
  },
  {
    image: "/images/article/business/04.png",
    text: "He wears a sweater by MARTINE ROSE. | Image credit XYZ",
  },
];
