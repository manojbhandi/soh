...
const SubscribeNewsletter = () => {
  return (
    <>
      <h4 className="text-black xl:mr-[7.813vw] font-fh xl:text-[1.667vw] xl:mb-[4.167vw]">Subscribe for our Newsletters</h4>
      <div className="row border-b border-solid border-[#000] xl:gap-x-[1vw]">
        <InputField type={'email'} placeholder={'Enter Email ID'} customClass={'flex-1 xl:text-[0.833vw] placeholder:text-black text-black'}/>
        <button className="flex-none xl:w-[2.5vw] xl:h-[2.5vw]">
